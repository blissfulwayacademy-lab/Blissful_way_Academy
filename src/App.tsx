...
function BookingModal({ open, onClose }: BookingModalProps) {
  ...
  return (
    ...
    >
      <div
        className="relative max-h-[92vh] w-full max-w-xl overflow-y-auto rounded-3xl border border-amber-500/30 bg-neutral-900 p-6 shadow-2xl shadow-amber-950/30 sm:p-8"
      ...
      >
        ...
        {!submitted ? (
          <>
            ...
            <form onSubmit={handleSubmit} className="mt-7 grid gap-4 sm:grid-cols-2">
              <label className="text-sm text-neutral-300 sm:col-span-2">
                Parent full name
                <input required name="name" placeholder="Your full name" className="form-input" />
              </label>
              ...
              <label className="text-sm text-neutral-300 sm:col-span-2">
                Preferred time slot
                <select required name="time" className="form-input">
              ...
              <button type="submit" className="button-gold mt-2 sm:col-span-2">
                Request my trial <ArrowRight size={17} />
              </button>
            </form>
          </>
        ) : (
          <div className="flex min-h-[340px] flex-col items-center justify-center text-center">
            ...
            <button onClick={onClose} className="button-outline mt-7">
